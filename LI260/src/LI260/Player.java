...
public class Player {
     ...
     */
    private void drawTile(Pioche p) {
    ...
    /**
     * Shows tiles that can be played. Lets you pick which one you want to play with.
     * @param p Board
     * @param bag Pioche
     */
    ...
    public String toString() {
        return (name + " " + printTiles(tilesAtHand));
    }

    /**
     * Prints tiles.
     *
     * @param ar ArrayList ar which contents will be printed.
     * @return String
     */
